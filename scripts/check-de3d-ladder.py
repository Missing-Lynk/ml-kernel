...
REGS = [
    (0x2E10, 0xFFFFFFFF), (0x2E14, 0xFFFFFFFF), (0x2E18, 0xFFFFFFFF),
    (0x2E28, 0x000001FF), (0x2E2C, 0xFFFFFFFF), (0x2E4C, 0x00003FFF),
    (0x2E94, 0x00FFFFFF), (0x2E9C, 0x00FFFFFF), (0x2EA0, 0xFFFFFFFF),
    (0x2EA4, 0x03FF1FFF), (0x2EA8, 0x03FF0FFF), (0x2EAC, 0x000001FF),
    (0x2EB0, 0xFFFFFFFF),
] + [(0x2EBC + i * 4, 0xFFFFFFFF) for i in range(32)]

MEASURED = {
    366592: {
        0x2E10: 0x17450A15, 0x2E14: 0x1E3C96B4, 0x2E18: 0x17450A15,
        0x2E28: 0x0000000A, 0x2E2C: 0x00000100, 0x2E4C: 0x00003FFF,
        0x2E94: 0x00273940, 0x2E9C: 0x00101033, 0x2EA0: 0x150A0F0A,
        0x2EA4: 0x00240045, 0x2EA8: 0x00240045, 0x2EAC: 0x0000000A,
        0x2EB0: 0x00011000, 0x2EBC: 0x00000102, 0x2EC0: 0x03040505,
        0x2EC4: 0x06070809, 0x2EC8: 0x0A0B0C0D, 0x2ECC: 0x0E0F1010,
        0x2ED0: 0x10101010, 0x2ED4: 0x10111111, 0x2ED8: 0x11111112,
        0x2EDC: 0x12131313,
    },
    1008128: {
        0x2E10: 0x11100E1D, 0x2E14: 0x1E3C5EB4, 0x2E18: 0x11100E1D,
        0x2E28: 0x0000000A, 0x2E2C: 0x00000100, 0x2E4C: 0x00003FFF,
        0x2E94: 0x00273940, 0x2E9C: 0x00131333, 0x2EA0: 0x1D131C13,
        0x2EA4: 0x00210055, 0x2EA8: 0x00210055, 0x2EAC: 0x0000000A,
        0x2EB0: 0x00061B00, 0x2EBC: 0x00010203, 0x2EC0: 0x04050607,
        0x2EC4: 0x09090B0B, 0x2EC8: 0x0B0B0C0D, 0x2ECC: 0x0E0F1010,
        0x2ED0: 0x10101010, 0x2ED4: 0x10111111, 0x2ED8: 0x12121213,
        0x2EDC: 0x13141414,
    },
}
...
def de3d_from_blob(blob, gain_q16):
    ...
    out = [
        ...
        fld(0x7C, 1) | (fld(0x80, 1) << 1) | (fld(0x84, 1) << 2) |
        (fld(0x88, 1) << 3) | (fld(0x2E0, 1, 0) << 4) |
